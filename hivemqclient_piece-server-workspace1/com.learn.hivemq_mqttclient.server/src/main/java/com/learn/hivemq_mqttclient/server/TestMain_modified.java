...
public class TestMain_modified {
	...
	public static void main(String[] args) {
        ...
        */
        ...
        // 一定要注意 connect之后 如果不用thenAccept之类的方法, 就一定要 让他等一等, 等connect成功
		...
		*/
        for(int i=0;i<=1000-1;i++) {
        	...
        	*/
        	...
        	/*
        	//A2方法中  client1.publish(publishMessage); 和   System.out.println(str_content_tmp); 可以换成下面这种, 看起来更清晰一些 
        	...
        	*/
        	/*
        	//B2方法中  c1.send(); 和   System.out.println(str_content_tmp); 可以换成下面这种, 看起来更清晰一些
