 ...
 *
 */
public class TestMain_modified2_CouldBeDeleted2 {


	public static void main(String[] args) {

        //String topic        = "MQTT Examples";
        String topic        = "zigbee2mqtt/bridge/logging";
		...
		*/
        ...
        for(int i=0;i<=1;i++) {
        	...
        	String str_content_tmp1=null;
			try {
				str_content_tmp1 = mapperTmp.writeValueAsString(lhmap1);
			} catch (JsonProcessingException e1) {
				// TODO Auto-generated catch block
				e1.printStackTrace();
			}
        	LinkedHashMap<String,Object> lhmap1_ab = new LinkedHashMap<>();
        	lhmap1_ab.put("level", "info");
        	lhmap1_ab.put("message", "MQTT publish:topic'zigbee2mqtt/0x00124b00250c256f',"+"payload"+str_content_tmp1);
        	
        	String str_content_tmp=null;
			try {
				str_content_tmp = mapperTmp.writeValueAsString(lhmap1_ab);
			} catch (JsonProcessingException e1) {
				// TODO Auto-generated catch block
				e1.printStackTrace();
			}
        	//client1.publishWith().topic(topic).qos(MqttQos.AT_LEAST_ONCE).payload(content.getBytes()).send();
			//str_content_tmp = "{"+str_content_tmp+"}";
